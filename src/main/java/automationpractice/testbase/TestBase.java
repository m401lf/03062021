package automationpractice.testbase;

import automationpractice.helper.browserConfiguration.BrowserType;
import automationpractice.helper.browserConfiguration.ChromeBrowser;
import automationpractice.helper.browserConfiguration.FirefoxBrowser;
import automationpractice.helper.browserConfiguration.IExploreBrowser;
import automationpractice.helper.browserConfiguration.config.ObjectReader;
import automationpractice.helper.browserConfiguration.config.PropertyReader;
import automationpractice.helper.excel.ExcelHelper;
import automationpractice.helper.javaScript.JavaScriptHelper;
...
import automationpractice.lib.AppLib;
import automationpractice.utils.ExtentManager;
...
public class TestBase {
    ...
    public void beforeMethod(Method method) {
        ...
        log.info("***" + method.getName() + "***" + "TestStarted" + "***");
    }
    ...
    public void getNavigationScreen(WebDriver driver) {
        logExtentReport("capturing ui navigation screen...");
