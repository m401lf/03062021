...
public class CheckPoint {
    private static final Logger log = LoggerHelper.getLogger(CheckPoint.class);
    ...
    public static void clearHashMap() {
        ...
        TestBase.logExtentReport("Clearing Results Hash Map");
        resultMap.clear();
    }
    ...
    private static void setStatus(String mapKey, String status) {
        ...
        TestBase.logExtentReport(mapKey + " :-> " + resultMap.get(mapKey));
    }
    ...
    public static void mark(String testName, boolean result, String resultMessage) {
        ...
        try {
            ...
            TestBase.logExtentReport("Exception Occurred...");
            setStatus(mapKey, FAIL);
            e.printStackTrace();
        }
    }
    ...
    public static void markFinal(String testName, boolean result, String resultMessage) {
        ...
        for (int i = 0; i < resultList.size(); i++) {
            if (resultList.contains(FAIL)) {
                ...
                TestBase.logExtentReport("Test Method Failed");
                Assert.assertTrue(false);
            } else {
                log.info("Test Method Successful");
                TestBase.logExtentReport("Test Method Successful");
